    ...
    <div class="modal-content">
      ...
      <form method="post" id="upload_form" align="left" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12">
              <input type="hidden" name="banner_id" id="banner_id" class="form-control">
              <div id="detail_div">
                <div class="box-body"> 
...
function getDataTable(){
  ...
  ajax: {
    url: "<?php echo base_url('jogja/banner/ajax_list') ?>",
    type:'POST',
  }
})
}
...
<script>  
  $(document).ready(function(){  
    $('#upload_form').on('submit', function(e){  
      ...
      $.ajax({  
         url:"<?php echo base_url(); ?>jogja/banner/jsonSaveData/",   
         method:"POST",  
         ...
         {  
          ...
          if(json['status']=='sukses'){
            ...
            $('#span_filename').html(json['data']['filename']);
          }else{
            //alert('oke');
            alert(json['data']);
  ...
  function jsonDeleteData(post_id){
    ...
    if(!konfirmasi){
      ...
      $.ajax({
      url: '<?php echo base_url();?>jogja/banner/jsonDeleteData',
      type: 'POST',
      data: {banner_id:post_id,
          },
      dataType: 'json',
