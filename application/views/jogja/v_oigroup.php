...
<div class="box box-warning">
  ...
  <div class="box-header">
      <a href="<?php echo base_url();?>jogja/oigroup/add" class="btn btn-success"><i class="fa fa-plus"></i> Add New</a> 
      <!-- <a href="javascript:void(0)" onclick="showAddNew()" class="btn btn-rounded btn-inline btn-success"><i class="fa fa-plus"></i> Add New</a> -->
  </div>
  <!-- /.box-header -->
  <div class="box-body">
    <table id="example2" class="table table-bordered table-striped">
      <thead>
          ...
          <th width="5px">No Telpon</th>
          <th width="5px">Kota</th>
	        <th class="no-sort" width="5px"><center>Aksi</center></th>
	      </tr>
      </thead>
		</table>
	</div>
...
<script>
    ...
    $('#example2').DataTable({
      ...
      ajax: {
        ...
        url: "<?php echo base_url('jogja/oigroup/ajax_list') ?>",
        type:'POST',
...
<script>
   function jsonDeleteData(post_ids){
    ...
    if(!konfirmasi){
      ...
      $.ajax({
      url: '<?php echo base_url();?>jogja/oigroup/jsonDeleteData',
      type: 'POST',
      data: {ids:post_ids,
          },
      dataType: 'json',
